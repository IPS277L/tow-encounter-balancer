...
| AUDIT-005 | Player’s Guide 1.4, 12, 156–157 | DEFINITION/RULE | Exacting Test накапливает успехи нескольких Tests во времени; Casting привязывает попытку к Lore и использует последний бросок как Potency | Casting-specific accumulation и normal CAST/WAIT реализованы в `RULE-MAGIC-004`; общий Exacting lifecycle остаётся draft `RULE-TEST-007` | partially_resolved |
