...
R1 завершён, все строки Miscast Table реализованы. До M2 продолжается K1: сначала недостающий Casting Test lifecycle, затем action/turn/spatial orchestration по зависимостям, зафиксированным аудитом.
