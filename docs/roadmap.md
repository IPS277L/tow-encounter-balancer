...
Готово ядро Test/Opposed/Attack/Staggered/Wound и единый `ResolutionResult`. До завершения K1 остаются специализированные эффекты Wounds Table и заменяющие обычный Damage impacts; конкретные Talents и NPC Abilities наращиваются поверх тех же фаз.
