...
Готово ядро Test/Opposed/Attack/Staggered/Wound, специализированные эффекты всех строк Wounds Table и единый `ResolutionResult`. До завершения K1 остаются заменяющие обычный Damage impacts; конкретные Talents и NPC Abilities наращиваются поверх тех же фаз.
