...
Основные источники: `BOOK-PLAYER-GUIDE`, страницы 73–81, 92–97, 111–112; `BOOK-GM-GUIDE`, страницы 89–91 и профили NPC на страницах 92–185. Статус: `draft`; это классификация механик, а не полный каталог всех Talents, предметов и NPC.
