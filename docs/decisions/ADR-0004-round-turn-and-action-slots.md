...
- Запрещать завершение хода с зарезервированным, но неисполненным обычным Attack. Для ещё не подключённых action kinds временно сохранять прежнюю границу резервации.
