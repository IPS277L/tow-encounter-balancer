...
- Запрещать завершение хода с зарезервированным, но неисполненным обычным Attack или spell Improvise. Для ещё не подключённых action kinds временно сохранять прежнюю границу резервации.
...
Срез пока не определяет Awareness-результат засады, incidental/free actions, расход Fate, эффекты Aim/Help/Recover/Manoeuvre, исполнение подготовленных Miscast follow-ups, target discovery, общий battle aggregate, окончание боя и AI выбора порядка. Обычный Attack, normal post-Casting, triggered preparation, добровольное прекращение Casting и skipped Casting consequence после Attack уже исполняются; Attack/Casting Test должны завершиться до конца хода. Charge остаётся Manoeuvre. Завершение активного хода требует зарезервировать standard action; если позднее книжный источник потребует явный pass/skip, он должен быть представлен отдельным нормативным действием или решением, а не пустым ходом.
