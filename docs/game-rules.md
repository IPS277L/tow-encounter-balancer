...
Книжные правила K1, включая Casting и Miscast, нормализуются отдельно в [`docs/rules/`](rules/) и намеренно не переносятся в эту спецификацию старого прототипа.
