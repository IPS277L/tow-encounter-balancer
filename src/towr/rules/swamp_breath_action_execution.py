...
from towr.domain.swamp_breath_models import (
    ...
    _validate_swamp_breath_context,
)
...
from towr.rules.troll_hazards import troll_hag_swamp_breath_hazard
from towr.rules.zone_hazard_resolution import resolve_zone_hazard


def execute_swamp_breath_action(
    ...
    *,
    ...
    """Execute Troll Hag Swamp Breath against every creature in one Zone."""
    ...
    _validate_swamp_breath_context(request)
    ...
    return SwampBreathActionExecutionResult(
